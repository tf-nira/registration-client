...
public class RegistrationConstants {
	...
	public static final String ALIENREPLACEMENT= "ALIENREPLACEMENT";
	...
	public static final String STUB_SCANNER_ENABLED = "mosip.registration.stubscanner_impl_enabled";
